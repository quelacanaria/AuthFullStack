...
function ChangePassword(){
    const {token, formSubmitChangePassword, showError, containerFailedError, showGreet,
        containerGreetMess, newData, setNewData
        ...
        <>
            <div className="min-h-screen p-4 flex justify-center items-start pt-10">
                <div className="card w-full max-w-2xl bg-base-100 shadow-xl border border-base-300">
                    <form onSubmit={formSubmitChangePassword} className="card-body">
